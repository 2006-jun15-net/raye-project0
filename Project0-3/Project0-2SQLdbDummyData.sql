...
--Vendor List
SET IDENTITY_INSERT VendorList ON
INSERT INTO VendorList(VendorIndex,VendorName,VendorStAddress,VendorCity,VendorState,VendorZip,VendorCountry,VendorEmail,VendorPhone)
...
SET IDENTITY_INSERT VendorList OFF
GO

--Item Inventory
SET IDENTITY_INSERT ItemList ON
INSERT INTO ItemList([ItemIndex],[ItemName],[ItemDescription],[ItemPrice],[ItemVendor]) 
...
INSERT INTO Employees([EmployeeId],[FirstName],[MiddleInit],[LastName],[Title],[Supervisor],[isManager],[isActive])
...
--Employee Details
INSERT INTO EmployeeDetails([EmployeeId],[EmployeeEmail],[EmployeePhone],[EmployeeStAddress],[EmployeeCity],[EmployeeState],[EmployeeZip],[EmployeeSalary]) 
...
--Stores
INSERT INTO Stores([StoreId],[StoreManager],[StoreStAddress],[StoreCity],[StoreState],[StoreZip]) 
...
INSERT INTO Customers([CustomerIndex],[FirstName],[LastName],[StreetAddress],[City],[State],[Zip],[Email],[Phone],[PreferredStore]) 
...
INSERT INTO Orders([OrderIndex],[OrderId],[CustomerId],[OrderDateTime],[OrderStatus],[OrderStatusDate]) 
...
--Order Invoices
SET IDENTITY_INSERT OrderInvoice ON
INSERT INTO OrderInvoice([InvoiceLineNumber],[OrderIndex],[ItemId],[ItemQuantity]) 
...
INSERT INTO OrderInvoice([InvoiceLineNumber],[OrderIndex],[ItemId],[ItemQuantity]) 
	...
	(35,44,1054,8),(36,126,1004,10),(37,179,1003,3),(38,154,1100,9),(39,178,1061,6),(40,72,1079,2);
INSERT INTO OrderInvoice([InvoiceLineNumber],[OrderIndex],[ItemId],[ItemQuantity]) 
...
SET IDENTITY_INSERT OrderInvoice OFF
GO

--Customer Reviews
INSERT INTO CustomerFeedback([CustomerIndex],[StoreReviewed],[CustomerRating],[CustomerFeedback]) 
...
--Store Inventory
SET IDENTITY_INSERT StoreInventory ON
 INSERT INTO StoreInventory([storeInventory_PK],[storeNumber],[ItemId],[Quantity]) 
	VALUES(1,14,1083,14),(2,13,1055,18),(3,10,1020,9),(4,12,1054,12),(5,13,1067,13),(6,14,1018,2),(7,10,1028,14),(8,14,1073,5),(9,12,1038,3),
	(10,11,1048,6),(11,11,1055,4),(12,14,1026,4),(13,11,1078,14),(14,11,1048,11),(15,10,1081,11),(16,13,1014,20),(17,11,1017,4),(18,12,1035,2),
	(19,11,1028,18),(20,11,1049,18),(21,13,1082,12),(22,12,1064,16),(23,11,1008,14),(24,11,1001,14),(25,14,1002,9),(26,11,1039,12),(27,12,1033,10),
	(28,14,1073,4),(29,13,1048,4),(30,13,1029,4),(31,14,1050,6),(32,13,1060,15),(33,12,1001,2),(34,11,1049,14),(35,13,1055,7),(36,12,1025,20),
	(37,11,1024,7),(38,11,1040,1),(39,10,1079,13),(40,10,1061,7),(41,10,1059,8),(42,14,1024,1),(43,11,1001,4),(44,11,1099,11),(45,11,1007,16),
	(46,10,1071,11),(47,14,1050,2),(48,13,1082,16),(49,12,1021,2),(50,10,1067,4),(51,12,1043,13),(52,14,1091,18),(53,11,1021,10),(54,13,1099,20),
	(55,12,1046,8),(56,11,1054,15),(57,11,1049,7),(58,10,1032,1),(59,10,1037,16),(60,13,1052,3),(61,14,1072,17),(62,14,1080,15),(63,11,1067,15),
	(64,10,1089,4),(65,13,1052,19),(66,11,1035,14),(67,10,1044,9),(68,12,1080,11),(69,13,1032,13),(70,11,1067,4),(71,12,1009,15),(72,12,1009,7),
	(73,10,1065,5),(74,13,1008,16),(75,10,1076,5),(76,13,1051,14),(77,14,1007,17),(78,14,1088,9),(79,11,1059,7),(80,13,1012,6),(81,13,1026,9),
	(82,11,1075,16),(83,14,1004,17),(84,14,1041,10),(85,14,1013,13),(86,12,1036,7),(87,10,1033,1),(88,13,1007,1),(89,14,1055,6),(90,11,1016,17),
	(91,12,1092,14),(92,11,1056,17),(93,14,1044,2),(94,10,1087,16),(95,10,1007,4),(96,14,1044,16),(97,12,1071,19),(98,10,1041,9),(99,13,1011,18),
	(100,11,1011,3);
SET IDENTITY_INSERT StoreInventory OFF